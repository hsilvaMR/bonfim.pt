...
<?php $__env->startSection('content'); ?>
	...
	<a href="<?php echo e(route('newContactNewsletterPageB')); ?>" class="abt bt-verde modulo-botoes"><i class="fas fa-plus"></i> Adicionar Novo</a>
	...
	<div class="modulo-table">
  		<div class="modulo-scroll">
        		...
        		<?php $__currentLoopData = $newsletter; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      				<tbody>
            			<tr id="linha_<?php echo e($val->id); ?>">
			            	<td class="display-none"></td>
			              	<td><?php echo e($val->id); ?></td>
			              	<td><?php echo e($val->email); ?></td>
			              	<td><?php if($val->lingua == 'pt'): ?> PT <?php else: ?> EN <?php endif; ?></td>
