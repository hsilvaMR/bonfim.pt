...
<?php $__env->startSection('content'); ?>
  ...
  <a href="<?php echo e(route('addImgProjetoB')); ?>" class="abt bt-verde modulo-botoes"><i class="fas fa-plus"></i> <?php echo e(trans('backoffice.addNew')); ?></a>
  		...
  		<div class="modulo-scroll">
  	  		<table class="modulo-body" id="sortable">
  	    		<thead>
			            ...
			            <th><?php echo e(trans('backoffice.Description')); ?></th>
                  <th><?php echo e(trans('backoffice.Online')); ?></th>
			            <th><?php echo e(trans('backoffice.Option')); ?></th>
    		  		</tr>
    			</thead>
        		<?php $__currentLoopData = $projeto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      				<tbody>
            			<tr id="linha_<?php echo e($val->id); ?>">
			            	<td class="display-none"></td>
			              	<td><?php echo e($val->id); ?></td>
			              	<td><img height="100" src="<?php echo e($val->imagem_pt); ?>"></td>
			              	<td><?php echo e($val->descricao_pt); ?></td>
                      <td class="check-small">
                        ...
                        <label for="check3<?php echo e($val->id); ?>"><span></span></label>
			              	...
			              	<td class="table-opcao">
			              		<a href="<?php echo e(route('editImgProjetoB',$val->id)); ?>" class="table-opcao">
