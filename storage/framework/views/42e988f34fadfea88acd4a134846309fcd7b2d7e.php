...
<script src="<?php echo e(asset('backoffice/js/modernizr.2.5.3.min.js')); ?>"></script>
<script src="<?php echo e(asset('backoffice/js/app.js')); ?>"></script>
<script src="<?php echo e(asset('backoffice/js/javatm.js')); ?>"></script>
<!-- NOTIFIC8 -->
<script src="<?php echo e(asset('backoffice/vendor/notific8/jquery.notific8.min.js')); ?>"></script>
