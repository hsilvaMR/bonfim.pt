...
<?php $__env->startSection('content'); ?>
  <?php if($funcao=='new'): ?><?php $arrayCrumbs = [ trans('backoffice.Website') => route('galeriaHomePageB'), 'Adicionar Imagem' => route('galeriaHomeNewPageB') ]; ?><?php endif; ?>
  ...
  <div class="page-titulo">
    <?php if($funcao=='new'): ?> Adicionar Imagem <?php endif; ?>
  </div>



  <form id="newForm" method="POST"  action="<?php echo e(route('saveGaleriaHomeForm')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
  ...
  $('#newForm').on('submit',function(e) {
      ...
      .done(function(resposta) {
        ...
        if(resp.estado=='sucesso'){          
          ...
          window.location.href = "<?php echo e(route('galeriaHomePageB')); ?>";       
