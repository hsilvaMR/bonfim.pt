<!--<header>
  <div class="container-fluid">
  	<a href="<?php echo e(asset('')); ?>" target="_blank"><div class="header-logo"></div></a>
...
<header onmouseover="mcancel()" onmouseout="mcloset()">
  <div class="container-fluid">
    ...
    <div id="menuAccount" class="header-menu-account">
      <a href="<?php echo e(route('logoutPageB')); ?>"><div class="header-menu-item"><?php echo e(trans('backoffice.Logout')); ?></div></a>
    </div>
