	...
	<div class="row">
		<div class="col-sm-5 col-lg-4" style="padding: 0 !important;">
			<div class="img-magnifier-container">
			  <a href="<?php echo e(route('bonfimLocalizacaoPage')); ?>"><img id="myimage" src="/img/bonfim/rua_mapa.png"></a>
        <div id="log"></div>
			</div>
		</div>
      ...
      <!--<div id="video_info" style="cursor:pointer;" onclick="openModalVideo();">
        <div class="bonfim-apresentacao">
          ...
          <video id="video_info_video"  style="position:absolute;right:0;bottom:0;min-width:100%;min-height:100%;width:auto;height:auto;z-index:-100;background-size:cover;overflow:hidden;filter:blur(6px);" autoplay loop>
			...
			<div class="bonfim-apresentacao">
        <div class="bonfim-apresentacao-txt">
          <h3><?php echo trans('bonfim.APRESENTACAO'); ?></h3>
          <p style="text-shadow: 0px 1px 5px rgb(0 0 0 / 25%);"><?php echo trans('bonfim.APRESENTACAO_txt'); ?></p>
        </div>
    	</div>
		</div>
	</div>
...
<div class="tx-branco" style="padding:0px 20px;">
	<div id="bonfim_container_slide" class="container">
		...
		<div class="bonfim-slide">
          ...
          <?php $__currentLoopData = $apartamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide bonfim-slide-swiper" style="background-image:url('<?php echo e($value->imagem_home); ?>');">
              <a style="height:100%;width:100%;" href="<?php echo e(route('bonfimApartamentosPage',$value->id)); ?>"></a>
            </div>
...
<div id="swiper-container-noticia" class="swiper-container">
    <div class="swiper-wrapper">
      <?php $__currentLoopData = $noticias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="swiper-slide" style="background-image:url('<?php echo e($val['rasgao']); ?>');background-size: 100% 100%;">
          <a href="<?php echo e(route('bonfimNoticiaPage',$val['id'])); ?>">
            <div style="padding:0px 20px;">
              <h3 class="noticia-titulo"><?php echo $val['titulo']; ?></h3>
              <label class="noticia-data"> <?php echo $val['data_noticia']; ?></label>
            </div>
          </a>
        </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<div class="barra_progressao_xl container">
  <div style="position:relative;height:200px;">
    <div style="height:20px;margin-bottom:10px;color:#192533;font-size:16px;line-height:20px;">  
      <span style="position: absolute;left:0;color:<?php echo e($color_texto_inicio); ?>;font-weight:600;font-family:'Proxima Nova Semibold';"> </span> 
      <span id="timeline_uniao_data" style="position: absolute;right:5px;font-weight:600;font-family:'Proxima Nova Semibold';"><?php echo e($data_fim); ?></span>
    </div>
    ...
    <div style="width:calc(100% - 70px);position:absolute;left:37px;">
      ...
      <label class="timeline_barra_verde" style="width:<?php echo e($calc_incio); ?>px;height:15px;background-color:#E8F1FB;margin-top:15px;margin-right:-4px;margin-left:10px;">
        <?php if(($width_verde_inicio > 0) && ($width_verde_inicio < 100)): ?>
          <label style="width:calc(100% - <?php echo e($width_verde_inicio); ?>%);height:15px; background-color:#36B289;border-top-right-radius: 50px 50px;border-bottom-right-radius: 50px 50px;"></label>
        <?php elseif($width_verde_inicio == 100): ?>
          <label style="width:100%;height:15px; background-color:#36B289;"></label>
        <?php endif; ?>
      </label>
      <?php $__currentLoopData = $array_fases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      
        <label id="fase_img_<?php echo e($fase['id']); ?>" class="timeline_fase" style="position:relative">
         
          <label style="position:absolute;top:-60px;font-size:16px;color:<?php echo e($fase['color_texto']); ?>;width:70px;line-height:12px;font-weight:bold;font-family:'Proxima Nova Semibold';"><?php echo e($fase['data_inicio']); ?></label>

          <img  style="margin-top:-29px;position:relative;" height="50" src="<?php echo e($fase['img_visto']); ?>">

            <div style="cursor:pointer;">
              <label style="position:absolute;bottom:0;top:30px;left:-20px;font-size:12px;text-align:center;width:90px;">
                <label  style="width:90px;height:50px;vertical-align:bottom;display:table-cell;font-family:'Proxima Nova Regular';font-weight:bold;color:#192533;"><?php echo e($fase['fase']); ?></label>
              </label>

              <label style="position:absolute;bottom:0;top:80px;left:-20px;font-size:10px;text-align:center;width:90px;">
                <label style="width:90px;font-family:'Proxima Nova Regular';color:#60789A;"><?php echo e($fase['estado']); ?></label>
              </label>
            </div>
            
        </label>
        <label id="fase_<?php echo e($fase['id']); ?>" class="timeline_barra_branca" style="width:<?php echo e($fase['largura_barra']); ?>px;height:15px;background-color:#E8F1FB;margin-top:25px;margin-right:-5px;margin-left:-5px;">
          <?php if(($fase['barra_verde'] > 0) && ($fase['barra_verde'] < 100)): ?>
            <label style="width:calc(100% - <?php echo e($fase['barra_verde']); ?>%);height:15px; background-color:#36B289;border-top-right-radius: 50px 50px;border-bottom-right-radius: 50px 50px;"></label>
          <?php elseif($fase['barra_verde'] == 100): ?>
            <label style="width:100%;height:15px; background-color:#36B289;"></label>
          <?php endif; ?>
        </label>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div id="timeline_uniao" style="height:60px;width:60px;background-color:#36B289;color:#fff;border-radius:50%;border:3.5px solid #E8F1FB;position: absolute;right:0;z-index:100;text-align:center;"><span style="line-height:55px;font-size:15px;font-family:'Proxima Nova Regular';font-weight: bold;"><?php echo e($percentagem); ?>%</span></div>
  </div>
</div>
...
<!--<div class="barra_progressao_xs container">
  ...
  <div class="barra_progressao_xs_conteudo">
    <div style="display:flex;flex-direction:row;justify-content:center;align-items:center">
      ...
      <div style="width:15px;height:<?php echo e($calc_incio); ?>px;background-color:#E8F1FB;">
        <?php if(($width_verde_inicio > 0) && ($width_verde_inicio < 100)): ?>
          <div style="width:15px;height:calc(100% - <?php echo e($width_verde_inicio); ?>%); background-color:#36B289;border-bottom-left-radius: 50px 50px;border-bottom-right-radius: 50px 50px;"></div>
        <?php elseif($width_verde_inicio == 100): ?>
    ...
    <?php $__currentLoopData = $array_fases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div style="display:flex;flex-direction:row;justify-content:center;align-items:center">
       <div>
        <div style="font-size:18px;color:<?php echo e($fase['color_texto']); ?>;font-weight:bold;font-family:'Proxima Nova Semibold';float:left;width:64px;line-height:48px;"><?php echo e($fase['data_inicio']); ?></div>
     
        <img style="margin-left:15px;margin-top:-1px;margin-bottom:-1px;"  height="50" src="<?php echo e($fase['img_visto']); ?>">

        <label style="margin-left:20px;font-size:15px;font-family:'Proxima Nova Regular';font-weight:bold;text-align:left;position:absolute;"><?php echo e($fase['fase']); ?>

          <br><label style="font-family:'Proxima Nova Regular';color:#60789A;"><?php echo e($fase['estado']); ?></label>
        </label>
      ...
      <div style="display:flex;flex-direction:row;justify-content:center;align-items:center">
        <span style="width:78px;"></span> 
        <div style="width:15px;height:<?php echo e($fase['largura_barra']); ?>px;background-color:#E8F1FB;">
          <?php if(($fase['barra_verde'] > 0) && ($fase['barra_verde'] < 100)): ?>
            <div style="width:15px;height:calc(100% - <?php echo e($fase['barra_verde']); ?>%); background-color:#36B289;border-bottom-left-radius: 50px 50px;border-bottom-right-radius: 50px 50px;"></div>
          <?php elseif($fase['barra_verde'] == 100): ?>
            <div style="width:15px;height:100%; background-color:#36B289;"></div>
          <?php endif; ?>
        </div>
  ...
  <div class="barra_progressao_xs_inicio" style="text-align:center;margin-top:-4px;">
    <span style="font-weight:600;font-family:'Proxima Nova Semibold';font-size:18px;line-height:60px;margin-right:20px;"><?php echo e($data_fim); ?></span>
    <label class="barra_progressao_xs_fim" style="height:60px;width:60px;background-color:#36B289;color:#fff;border-radius:50%;border:5.5px solid #E8F1FB;text-align:center;margin-top:-1px;margin-right:6px;"><span style="line-height:48px;font-size:15px;font-family:'Proxima Nova Regular';font-weight: bold;"><?php echo e($percentagem); ?>%</span></label>
  </div>
</div>-->
...
<div class="barra_progressao_xs container">
  ...
  <div class="barra_progressao_xs_conteudo">
    <div style="width:15px;height:<?php echo e($calc_incio); ?>px;background-color:#E8F1FB;margin:0 auto;">

      <?php $height_linha = $width_verde_inicio/2; ?>

      <?php if(($height_linha > 0) && ($height_linha < 100)): ?>
        <div style="width:15px;height:calc(100% - <?php echo e($height_linha); ?>%); background-color:#36B289;border-bottom-left-radius: 50px 50px;border-bottom-right-radius: 50px 50px;"></div>
      <?php elseif($height_linha == 100): ?>
        <div style="width:15px;height:100%; background-color:#36B289;"></div>
      <?php endif; ?>
    </div>
    ...
    align-items: center;">
        ...
        <div style="text-align:end;height:50px;float:left;">
          <label style="font-size:18px;color:<?php echo e($fase['color_texto']); ?>;font-weight:bold;font-family:'Proxima Nova Semibold';width:117px;line-height:48px;margin-right:20px;"><?php echo e($fase['data_inicio']); ?></label>
          <img style="margin-top:-5px;"  height="50" src="<?php echo e($fase['img_visto']); ?>">
        </div>

        <label style="width:120px;font-size:13px;font-family:'Proxima Nova Regular';font-weight:bold;text-align:left;float:right;margin-left:20px;margin-top:20px;"><?php echo e($fase['fase']); ?>
      ...
      <div style="width:15px;height:<?php echo e($height_fase); ?>px;background-color:#E8F1FB;margin:-3px auto 0 auto;">
        <?php if(($height_fase_verde > 0) && ($height_fase_verde < 100)): ?>
          <div style="width:15px;height:calc(100% - <?php echo e($height_fase_verde); ?>%); background-color:#36B289;border-bottom-left-radius: 50px 50px;border-bottom-right-radius: 50px 50px;"></div>
        <?php elseif($height_fase_verde == 100): ?>
          <div style="width:15px;height:100%; background-color:#36B289;"></div>
        <?php endif; ?>
      </div>
  ...
  <div class="barra_progressao_xs_inicio" style="text-align:center;height:50px;text-align:center;height:70px;margin:0 auto;display:inline-block;width:100%;display:flex;flex-direction:row;justify-content:center;align-items:center;">
    <div style="text-align:end;height:70px;margin-top:-8px;">
      <label style="width:110px;font-weight:600;font-family:'Proxima Nova Semibold';font-size:18px;line-height:60px;margin-right:20px;"><?php echo e($data_fim); ?></label>
      <label class="barra_progressao_xs_fim" style="height:60px;width:60px;background-color:#36B289;color:#fff;border-radius:50%;border:5.5px solid #E8F1FB;text-align:center;margin-top:-1px;margin-right:6px;"><span style="line-height:48px;font-size:15px;font-family:'Proxima Nova Regular';font-weight: bold;"><?php echo e($percentagem); ?>%</span></label>
...
<div class="bonfim-div-preto">
    ...
    <h2 class="bonfim-tit"><?php echo e(trans('bonfim.PROJECTO')); ?></h2>
    ...
    <div id="swiper-container-projeto" class="swiper-container" style="width:auto !important;">
      <div class="swiper-wrapper" style="width:auto !important;">
        ...
        <?php $__currentLoopData = $projetos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projeto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div id="slide_<?php echo e($projeto->id); ?>" class="swiper-slide swiper-div">
            <!--<img id="img_slide_<?php echo e($projeto->id); ?>" src="<?php echo e($projeto->imagem_sem_resolucao); ?>" onclick="openModalProjeto(<?php echo e($projeto->id); ?>,'<?php echo e($projeto->imagem); ?>');"/>-->

              <a data-toggle="modal" href="#modal_projeto" data-slider="<?php echo e($cont); ?>"><img src="<?php echo e($projeto->imagem_sem_resolucao); ?>"/></a>
         
            <div class="depois">
              <label><?php echo e($projeto->descricao); ?></label>
            </div>
          </div>
          <?php $cont++;?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <div class="container-fluid">
    ...
    <div class="bonfim-projeto-ficha"><?php echo trans('bonfim.ficha_tecnica'); ?> <?php echo $projeto_ficha->ficha_tecnica; ?></div>
  </div>
</div>
...
<div class="bonfim-div-preto">
	...
	<h2 class="bonfim-tit"><?php echo e(trans('bonfim.GALERIA')); ?></h2>
	<div class="bonfim-height-40"></div>
	<!-- Swiper -->
	<div id="swiper-container-galeria" class="swiper-container">
		<div class="swiper-wrapper">
      <?php $__currentLoopData = $galeria_home; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galeria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		  	<div class="swiper-slide" style="background-image:url('<?php echo e($galeria->imagem); ?>');" onclick="openModalGaleria('<?php echo e($galeria->imagem_fullscreen); ?>');"></div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		</div>
	</div>
            ...
            <div class="bonfim-contacto-width float-right">
              ...
              <span style="font-family: 'Segoeu';" class="tx-azul float-right"><?php echo e(trans('bonfim.campos_obrigatorios')); ?>*</span>
  				...
  				<div class="col-md-5 col-lg-4 bonfim-padding-left">
  					...
  					<textarea name="mensagem" class="bonfim-contacto-width bonfim-textarea" placeholder="<?php echo trans('bonfim.contact_boa_tarde'); ?>"></textarea>
  				</div>
  			</div>
      ...
      <form id="newsletterForm" action="<?php echo e(route('newsletterBonfimForm')); ?>" name="form" method="post">
  			<div class="row">
  				<div class=" col-sm-9 col-md-8 offset-md-1 col-lg-6 offset-lg-2  col-xl-5 offset-xl-3 bonfim-padding-right padding-left">
  					<label class="bonfim-div-newsletter-txt"><?php echo trans('bonfim.SUBSCREVER_txt'); ?></label><br>
  ...
  <div id="swiper1" class="swiper-container" style="height:100%;width:100%;">
    <div class="swiper-wrapper">
      ...
      <?php $__currentLoopData = $projetos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $projeto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="swiper-slide"><div class="swiper-zoom-container" data-swiper-zoom="5"><img src="<?php echo $projeto->imagem; ?>"></div></div>
...
<script>
  ...
  <?php $__currentLoopData = $array_fases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    $(function(){
      $("#fase_img_<?php echo $fase['id']; ?>").hover(
        function(){
          //Ao posicionar o cursor sobre a div
          $(this).css('transform', 'scale(1.4)');
          $(this).css('transition-duration', '0.5s');
          $('#fase_<?php echo $fase['id']; ?>').css('margin-left', '0px');
        },
        function(){
          //Ao remover o cursor da div
          $(this).css('transform', 'scale(1)');
          $(this).css('transition-duration', '0.5s');
          $('#fase_<?php echo $fase['id']; ?>').css('margin-left', '-5px');
  ...
  <?php $__currentLoopData = $array_fases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    $(function(){
      $("#fase_<?php echo $fase['id']; ?>").hover(

        function(){

          var largura = $("#fase_<?php echo $fase['id']; ?>").width();
          console.log(largura);
...
<script>
  ...
  function openModalGaleria(imagem){
    ...
    <?php $__currentLoopData = $galeria_home; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galeria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      $var_image = '<?php echo $galeria->imagem_fullscreen; ?>';
      if($var_image != imagem){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('site/layouts/default-bonfim-info', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>