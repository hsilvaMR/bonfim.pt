...
<?php $__env->startSection('content'); ?>
	...
	<div class="page-titulo">
	 ...
	 <a href="<?php echo e(route('newNewsPageB')); ?>" class="abt bt-verde modulo-botoes"><i class="fas fa-plus"></i> <?php echo e(trans('backoffice.addNew')); ?></a>
  		...
  		<div class="modulo-scroll">
  	  		<table class="modulo-body" id="sortable">
  	    		<thead>
    		    		...
    		    		<th>#</th>
			            <th><?php echo e(trans('backoffice.Title')); ?></th>
			            <th>Hiperligação</th>
			            <th><?php echo e(trans('backoffice.News_date')); ?></th>

			            <th><?php echo e(trans('backoffice.Insert_date')); ?></th>
      				...
      				<tbody>
            			<tr id="linha_<?php echo e($val->id); ?>">
			            	<td class="display-none"></td>
			              	...
			              	<td><?php echo e($val->titulo_pt); ?></td>
			              	<td><a target="_blank" href="<?php echo e($val->link_pt); ?>"><?php echo e($val->link_pt); ?></a></td>
			              	<td><?php echo e($val->data_noticia_pt); ?></td>
			              	...
			              	<td class="table-opcao">
			                	<a href="<?php echo e(route('editNewsPageB',$val->id)); ?>" class="table-opcao">
  	...
  	<div class="modal fade" id="myModalInformation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    	<div class="modal-dialog" role="document">
      		<div class="modal-content">
        		...
        		<div class="modal-body"><?php echo trans('backoffice.newsTx'); ?></div>
